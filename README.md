...
1. In the toolbar of the Cloud Shell pane, click the **Upload/Download files** icon, in the drop-down menu, click **Upload** and upload the files **az104-06-vms-loop-template.json** and **az104-06-vms-loop-parameters.json** into the Cloud Shell home directory.

1. Edit the **Parameters** file you just uploaded and change the password. As a best practice, secrets, like passwords, should be more securely stored in the Key Vault.
...
1. From the Cloud Shell pane, run the following to create the three virtual networks and four Azure VMs into them by using the template and parameter files you uploaded:
   ...
   ```
    ...
    >**Note**: If you got an error stating the VM size is not available please try these steps.
